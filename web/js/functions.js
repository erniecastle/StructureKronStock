...
jQuery(document).ready(function() {
    ...
    $('#commentForm').submit(function() {
        ...
        if (!onMessage) {
            ...
            $("#actualPrice").prop('disabled', false);
        }
        onMessage = false;
...
function ChangeOn(kindSolution) {
    ...
    var text = document.getElementById('textKey');
    var text2 = document.getElementById('textTitleStock');
    var text3 = document.getElementById('actualPrice');
    ...
    if (text.value === "" && dealer !== 1) {
        ...
        if (dealer === 1) {
            ...
            $.ajax({
                ...
                type: "POST",
                dataType: "json",
                url: "./designer/stockFunctions.php",
                data: data
            }).done(function(msg) {
                if (msg !== null) {
                    if (msg === 'full') {
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data === null || isEmpty(data)) {
                        ...
                        if (data[1] === null || isEmpty(data[2])) {
                            $('#imageView').attr('src', "imagesDesign/defaultImage.png")
                                    .width(250)
                                    .height(150);
                        } else {
                            $('#imageView').attr('src', "data:image/jpeg;base64," + data[2])
                                    .width(100)
                                    .height(100);
                        }
            ...
            if (confirm("Deseas eliminar este stock")) {
                showLoading("");
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if (data === 'D') {
                            ...
                            alert("No se puede eliminar: existen inversiones para este stock");
                        } else {
                            alert(data);
                        }
                        removeLoading();
...
function notValidUser() {
    $.magnificPopup.open({
        items: {
            src: '#invalid-user', // can be a HTML string, jQuery object, or CSS selector
            type: 'inline',
