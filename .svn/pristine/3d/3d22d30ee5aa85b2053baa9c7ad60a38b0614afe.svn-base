...
<html>
    ...
    <body>
        ...
        <div>
            <br>
            <h1 id="content" style="margin-left: 5%">Vista preeliminar de usuarios</h1>
            <br>
            <div class="container">
                <div class="row">
                    <input type="search" id="keyPost" name="keyPost" onkeypress="handle(event)" placeholder="clave-nombre-email">
                    <br><br>
                </div>
                <div id="getUsers">
