...
<html>
    <head>
        ...
        <script type="text/javascript" src="js/loadStocks.js"></script>
    ...
    <body>
                        ...
                        <div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
                            <nav class="link-effect-7" id="link-effect-7">
                                <ul class="nav navbar-nav">
                                    ...
                                    <li><a href="user.php" data-hover="Usuarios">Usuarios</a></li>
                                </ul> 
                            </nav>
                        </div>
                        <!-- /.navbar-collapse -->
        ...
        <div>
            <br>
            <h1 id="content" style="margin-left: 5%">Vista preeliminar de acciones</h1>
            <br>
            <div class="container">
                <div class="row">
