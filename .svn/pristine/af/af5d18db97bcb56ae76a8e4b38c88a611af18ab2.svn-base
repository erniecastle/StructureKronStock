...
$loadYql = new meYahoo();
$rd = $loadYql->getHistory($simbols, $startDate, $endDate);
...
//$yql_query_url = "http://query.yahooapis.com/v1/public/yql?q=SELECT%20*%20FROM%20yahoo.finance.historicaldata%20WHERE%20symbol%20%3D%20%22AAPL%22%20AND%20startDate%20%3D%20%222016-05-01%22%20AND%20endDate%20%3D%20%222017-02-03%22&format=json&diagnostics=true&env=store%3A%2F%2Fdatatables.org%2Falltableswithkeys&callback=";
